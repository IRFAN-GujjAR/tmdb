...
class MoviesSearch extends StatefulWidget {
  ...
  MoviesSearch({@required this.moviesList, @required this.searchQuery});
  ...
  void _getSearchedMovies() {
    ...
    if (moviesList.pageNumber < moviesList.totalPages) {
      ...
      _seeAllMoviesBloc.add(LoadMoreSeeAllMovies(
          previousMovies: moviesList,
          url: URLS.searchMovies(widget.searchQuery, pageNumber)));
    }
  }
