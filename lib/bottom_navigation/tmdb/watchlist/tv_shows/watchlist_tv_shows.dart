...
class _WatchListTvShowsState extends State<WatchListTvShows>
  ...
  Future<void> _getWatchListTvShows() async {
    _tvShowsItemsLoading = true;
    _pageNumber++;
    TvShowsList tvShowsList = await getWatchListTvShows(http.Client(), widget.sessionId, widget.sessionId, _pageNumber);
    setState(() {
