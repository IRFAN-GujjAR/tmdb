...
class FavouriteTvShows extends StatefulWidget {
  ...
  @override
  _FavouriteTvShowsState createState() => _FavouriteTvShowsState();
}

class _FavouriteTvShowsState extends State<FavouriteTvShows>
    with AutomaticKeepAliveClientMixin<FavouriteTvShows> {
  ...
  Future<void> _getSearchedTvShows() async {
    ...
    _pageNumber++;
    TvShowsList tvShowsList = await getFavouriteTvShows(http.Client(), widget.sessionId, widget.sessionId, _pageNumber);
    setState(() {
